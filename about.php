...
if (isset($_POST["avis"])) {
  if (!empty($_POST["avis"])) {
      ...
      $blogcontroller->addAvis($_POST['id'],$_POST['avis']); // Pass the object to the function
...
<?php foreach ($tab as $blog): ?>
    <div class="blog-post" data-id="<?php echo $blog['id']; ?>" data-date="<?php echo $blog['date_pub']; ?>" data-contenu="<?php echo $blog['contenu']; ?>">
        ...
        <form action="">
          ...
          <div class="radio-buttons">
              <label>
                  <input type="radio" name="avis" value="Like"> Like
              </label>
              <label>
                  <input type="radio" name="avis" value="Dislike"> Dislike
              </label>
              <button type="submit">ajout</button>
          </div>
        </form>

        <a href="javascript:void(0);" class="add-comment-btn" data-blog-id="<?php echo $blog['id']; ?>">Add comment</a>
        
        <div class="comment-form" id="comment-form-<?php echo $blog['id']; ?>" style="display:none;">
            <textarea placeholder="Write your comment..." rows="4" class="form-control" id="comment-text-<?php echo $blog['id']; ?>" name="contenu_c"></textarea>
            <button class="submit-comment-btn" data-blog-id="<?php echo $blog['id']; ?>" type="submit">Submit Comment</button>
        </div>
    </div>
<?php endforeach; ?>
