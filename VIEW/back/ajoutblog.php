<?php 
include 'C:/xampp/htdocs/mico-html11/CONTROLLER/blogc.php';  // Path to the controller
include 'C:/xampp/htdocs/mico-html11/MODEL/blogm.php';  // Path to the Event class
