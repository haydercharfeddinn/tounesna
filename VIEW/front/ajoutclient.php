...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // Valider les données
    if ($event_id === null || $nbrp === null || $nbrp <= 0) {
        ...
        $client = new clients(null, (int)$event_id, (int)$nbrp);
...
<head>
    ...
    <script>
        function validateForm() {
            ...
            if (!eventId) {
                document.getElementById("eventError").innerText = "Veuillez sélectionner un événement.";
                isValid = false;
            }
