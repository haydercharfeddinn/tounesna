...
<head>
    ...
    <title>Détails de l'Article - Mdhala Traditionnelle</title>
...
<body>
    <div class="details-container">
        <img id="article-image" src="mdhala.png" alt="Image de l'article">
        <h1 id="article-nom">Mdhala Traditionnelle</h1>
        <p id="article-description">Mdhala traditionnelle, parfaite pour les journées ensoleillées.</p>
        <p id="article-prix">Prix: 70 TND</p>
        <form method="POST" action="">
            <input type="hidden" name="nom" value="Mdhala Traditionnelle">
            <input type="hidden" name="prix" value="70">
