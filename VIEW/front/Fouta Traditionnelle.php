...
<head>
    ...
    <title>Détails de l'Article - Fouta Traditionnelle</title>
...
<body>
    <div class="details-container">
        <img id="article-image" src="fouta.png" alt="Image de l'article">
        <h1 id="article-nom">Fouta Traditionnelle</h1>
        <p id="article-description">Fouta légère, parfaite pour les bains et les plages.</p>
        <p id="article-prix">Prix: 40 TND</p>
        <form method="POST" action="">
            <input type="hidden" name="nom" value="Fouta Traditionnelle">
    ...
    <script>
        ...
        function afficherPanier() {
            ...
            panier.forEach((article, index) => {
                ...
                articleElement.innerHTML = `${article.nom} - ${article.prix} TND <button onclick="retirerDuPanier(${index})">Retirer</button>`;
        ...
        function afficherHistorique() {
            ...
            if (historiqueCommandes.length === 0) {
                ...
                historiqueCommandes.forEach((article, index) => {
                    const articleElement = document.createElement('div');
                    articleElement.innerHTML = `${article.nom} - ${article.prix} TND`;
