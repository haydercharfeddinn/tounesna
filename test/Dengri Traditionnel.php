...
<head>
    ...
    <title>Détails de l'Article - Dengri Traditionnel</title>
...
<body>
    <div class="details-container">
        <img id="article-image" src="dengri.png" alt="Image de l'article">
        <h1 id="article-nom">Dengri Traditionnel</h1>
        <p id="article-description">Dengri traditionnel parfait pour l'été.</p>
        <p id="article-prix">Prix: 150 TND</p>
        <form method="POST" action="">
            <input type="hidden" name="nom" value="Dengri Traditionnel">
