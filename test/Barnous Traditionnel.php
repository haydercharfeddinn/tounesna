...
<head>
    ...
    <title>Détails de l'Article - Barnous Traditionnel</title>
...
<body>
    <div class="details-container">
        <img id="article-image" src="barnous.png" alt="Image de l'article">
        <h1 id="article-nom">Barnous Traditionnel</h1>
        <p id="article-description">Barnous en laine, parfait pour les occasions spéciales et les cérémonies.</p>
        <p id="article-prix">Prix: 300 TND</p>
        <form method="POST" action="">
            <input type="hidden" name="nom" value="Barnous Traditionnel">
