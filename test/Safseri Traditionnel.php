...
<head>
    ...
    <title>Détails de l'Article - Safseri Traditionnelle</title>
...
<body>
    <div class="details-container">
        <img id="article-image" src="safseri.png" alt="Image de l'article">
        <h1 id="article-nom">Safseri Traditionnel</h1>
        <p id="article-description">Le sefsari de soie naturelle tunisien est un grand morceau de tissu qui sert à recouvrir les femmes.</p>
        <p id="article-prix">Prix: 250 TND</p>
        <form method="POST" action="">
            <input type="hidden" name="nom" value="Safseri Traditionnelle">
