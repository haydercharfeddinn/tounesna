...
<head>
    ...
    <title>Détails de l'Article - Jebba Pour Femme Traditionnelle</title>
...
<body>
    <div class="details-container">
        <img id="article-image" src="jebba2.png" alt="Image de l'article">
        <h1 id="article-nom">Jebba Traditionnelle Pour Femme </h1>
        <p id="article-description">Jebba élégante pour les femmes, idéale pour les cérémonies.</p>
        <p id="article-prix">Prix: 200 TND</p>
        <form method="POST" action="">
            <input type="hidden" name="nom" value="Jebba Pour Femme Traditionnelle">
